...
public class ViewOrganismePanel extends JPanel {
	...
	public ViewOrganismePanel(String nomDuClasse, List<OrganismeExt> info, String[] comboBoxValues) {
                JComponent leftComp = null;
                ComponentWithTable tableComp=null;
                tableComp = new MyComponents.OrganismeTable(info);
                leftComp = new AjouterPage.AjouterOrganisme(info, tableComp);
