	...
	private void initComponents(Object [][] info) {
		...
		//======== centerContent ======
		{
			...
			//======== buttonPanel ========
			{
				...
				ajouterBtn.setBounds(new Rectangle(new Point(500, 30), new Dimension(100,20)));
		...
		//======== ajouterPanel ========
		{
			...
			//---- title ----
			title.setText("Ajouter Groupe");
			title.setFont(new Font("Liberation Sans", Font.PLAIN, 26));
			ajouterPanel.add(title, CC.xywh(2, 1, 5, 1, CC.DEFAULT, CC.BOTTOM));
